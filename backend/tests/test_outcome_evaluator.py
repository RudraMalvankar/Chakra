...
def test_outcome_evaluator_captured_status():
    ctx = PaymentContext(payment_id="p_rec_1", amount_inr=1500.0, error_code="insufficient_funds")
...
def test_outcome_evaluator_outcome_success():
    ctx = PaymentContext(payment_id="p_rec_2", amount_inr=750.0, error_code="payment_timed_out")
...
def test_outcome_evaluator_outcome_captured():
    ctx = PaymentContext(payment_id="p_rec_3", amount_inr=2499.0, error_code="card_declined")
...
def test_outcome_evaluator_failed_status():
    ctx = PaymentContext(payment_id="p_fail_1", amount_inr=1200.0, error_code="insufficient_funds")
...
def test_outcome_evaluator_pending_status():
    ctx = PaymentContext(payment_id="p_pend_1", amount_inr=500.0, error_code="card_declined")
...
def test_outcome_evaluator_gateway_error():
    ctx = PaymentContext(payment_id="p_err_1", amount_inr=999.0, error_code="payment_timed_out")
...
def test_outcome_evaluator_none_or_empty_response():
    ctx = PaymentContext(payment_id="p_empty_1", amount_inr=499.0, error_code="expired_card")
    
    res_none = OutcomeEvaluator.evaluate(None, ctx)
    assert res_none.recovered is False
    assert ctx.current_state == PaymentState.RECOVERY_FAILED
    
    ctx2 = PaymentContext(payment_id="p_empty_2", amount_inr=499.0, error_code="expired_card")
...
def test_outcome_evaluator_rejects_fake_status():
    ctx = PaymentContext(payment_id="p_fake_1", amount_inr=3000.0, error_code="insufficient_funds")
