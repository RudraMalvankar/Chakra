...
const PRESETS = [
    ...
    { label: 'Sub Day 0: RETRY_NOW', payload: { case_type: 'SUBSCRIPTION', amount_inr: 999, failure_reason: 'subscription.failed', mandate_state: 'ACTIVE', customer_id: 'cust_sub_d0', method: 'UPI', churn_risk: 'LOW', fraud_risk: 'LOW', retry_count: 0, days_overdue: 0, grace_period_remaining: 7 } },
    { label: 'Sub Day 3: PAYMENT_LINK', payload: { case_type: 'SUBSCRIPTION', amount_inr: 1499, failure_reason: 'subscription.failed', mandate_state: 'ACTIVE', customer_id: 'cust_sub_d3', method: 'CARD', churn_risk: 'LOW', fraud_risk: 'LOW', retry_count: 1, days_overdue: 3, grace_period_remaining: 4 } },
    { label: 'Sub Day 7: VOICE_RECOVERY', payload: { case_type: 'SUBSCRIPTION', amount_inr: 2999, failure_reason: 'subscription.failed', mandate_state: 'ACTIVE', customer_id: 'cust_sub_d7', method: 'UPI', churn_risk: 'MEDIUM', fraud_risk: 'LOW', retry_count: 2, days_overdue: 7, grace_period_remaining: 0 } },
    { label: 'Sub Day 14: ESCALATE', payload: { case_type: 'SUBSCRIPTION', amount_inr: 4999, failure_reason: 'subscription.failed', mandate_state: 'ACTIVE', customer_id: 'cust_sub_d14', method: 'CARD', churn_risk: 'HIGH', fraud_risk: 'LOW', retry_count: 3, days_overdue: 14, grace_period_remaining: 0 } },
    { label: 'Sub Day 30: BLOCK', payload: { case_type: 'SUBSCRIPTION', amount_inr: 9999, failure_reason: 'subscription.halted', mandate_state: 'REVOKED', customer_id: 'cust_sub_d30', method: 'NETBANKING', churn_risk: 'HIGH', fraud_risk: 'LOW', retry_count: 5, days_overdue: 30, grace_period_remaining: 0 } },
